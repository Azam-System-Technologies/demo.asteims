...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url('manages')); ?>" class="nav-link">
              <i class="nav-icon fas fa-user"></i>
              <p>
              Mgmt & Support Staff
  ...
  <div class="content-wrapper">
   ...
   <div class="card">
  <div class="card-header"> Staff  Page</div>
  <div class="card-body">
      ...
      <form action="<?php echo e(url('/user/update')); ?>" method="post"enctype="multipart/form-data">
        ...
        <div class='form-group' >                        <label for="user_name" class="col-sm-2 control-label">
                    ...
                    <div class='form-group' >                        <label for="dob" class="col-sm-2 control-label">
...
<option value="Female">Female</option>
                    ...
                    <div class='form-group' >                        <label for="jod" class="col-sm-2 control-label">
                            Joining Date <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="jod" name="jod" value="<?php echo e($user->jod); ?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                                                    </span>
                    </div>
                    ...
                    <div class='form-group' >                        <label for="usertypeID" class="col-sm-2 control-label">
                            Role <span class="text-red">*</span>
                        </label>
                        
                        <div class="col-sm-6">
                            <select name="usertypeID" id='usertypeID'  class="form-control" value="<?php echo e($user->usertypeID); ?>">
<option value="0">Select Role</option>
<option value="15">asdfg</option>
<option value="14">Test</option>
<option value="12">Mark Attendence</option>
<option value="9" selected="selected">Director</option>
...
<?php /**PATH C:\xampp\htdocs\demo.asteims\resources\views/user/edit.blade.php ENDPATH**/ ?>