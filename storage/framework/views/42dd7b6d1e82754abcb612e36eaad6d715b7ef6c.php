  ...
  <div class="content-wrapper">
   ...
   <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header"> Show all Students</div>
                    <div class="card-body">
...
<option value="24">Test</option>
                            ...
                            <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12 pull-right drop-marg">
                                <select name="campusID" id='campusID' class='form-control select2'>
                            ...
                            <table class="table">
                                ...
                                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="<?php echo e(asset('/storage/images/studentimages/'.$item->file_path)); ?>" width="25px" alt="student photo" title="photo"></td>
                                        ...
                                        <td>
                                            <a href="<?php echo e(url('/student/show/'.$item->id)); ?>" title="View Student"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="<?php echo e(url('/student/edit/'.$item->id)); ?>" title="Edit Student"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                            <form method="POST" action="<?php echo e(url('student/delete')); ?>" accept-charset="UTF-8" style="display:inline">
...
<?php /**PATH C:\xampp\htdocs\demo.asteims\resources\views/student/index.blade.php ENDPATH**/ ?>