...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <div class="card">
  <div class="card-header">Management & Staff Page</div>
  <div class="card-body">

      <form action="<?php echo e(route('userstore')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<option value="Female">Female</option>
                    ...
                    <div class='form-group' >                        <label for="jod" class="col-sm-2 control-label">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="jod" name="jod" value="" >
                        </div>
                        <span class="col-sm-4 control-label">
                                                    </span>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\demo.asteims\resources\views/user/create.blade.php ENDPATH**/ ?>