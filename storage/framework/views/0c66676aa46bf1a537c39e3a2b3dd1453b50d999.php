...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <div class="card">
  <div class="card-header">Students Attendance Page</div>
  <div class="card-body">
      
      <form action="<?php echo e(route('studentattstore')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
       ...
       <option value="B">B</option>
        ...
        <input type="date" name="date" id="date" class="form-control"required></br>
          ...
          <button type="submit" class="btn btn-success btn-block btn-sm" title="Add Student Attendance" onclick="return confirm
             ('are you want to Add Student Attendance')"><i class="fa fa-trash-o" aria-hidden="true"></i> Attendance</button>
          </div>
        </div>
    </form>
...
<?php /**PATH C:\xampp\htdocs\demo.asteims\resources\views/markattendance/create.blade.php ENDPATH**/ ?>