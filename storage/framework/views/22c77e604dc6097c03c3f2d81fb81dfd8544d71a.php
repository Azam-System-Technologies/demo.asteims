...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <div class="card">
  <div class="card-header"> Edit Students Page</div>
  <div class="card-body">




      <form action="<?php echo e(url('/student/update')); ?>" method="post"enctype="multipart/form-data">
        <?php echo csrf_field(); ?>

        <input type="hidden" name="id" id="id" value="<?php echo e($students->id); ?>" id="id" />
        <label>Name<span class="text-danger">*</span></label></br>
        <input type="text" name="name" id="name" value="<?php echo e($students->name); ?>"class="form-control"required></br>
        <label>Guardian</label></br>
        <select name="guardian" id="guardian" value="<?php echo e($students->guardian); ?>" class="form-control">
       <option value="0">Select Guardian </option>
       <option value="7">AD (adlhr12345@gmail.com )</option>
<option value="8">Muhammad Akram</option>
<option value="11">NA (na786@hotmail.com )</option>
...
<option value="31">Shahab</option>
        ...
        <select name="gender" id="gender" value="<?php echo e($students->gender); ?>"  class="form-control">
...
<option value="AB-">AB-</option>
        ...
        <input type="text" name="religion" id="eligion" class="form-control"></br>
...
<option value="AX">Aland Islands</option>
        ...
        <select name="class_id" id="class_id" value="<?php echo e($students->class_id); ?>" class="form-control select2" required>
...
<option value="24">Test</option>
        ...
        <select name="section_id" id="section_id" value="<?php echo e($students->section_id); ?>" class="form-control select2" required>
        ...
        <label> Campus<span class="text-danger">*</span></label></br>
        <select name="campus_id" id="campus_id" value="<?php echo e($students->campus_id); ?>" class="form-control select2" required>
...
<option value="5">Arts</option>
        ...
        <input type="text" name="registerNo" id="registerNo" value="<?php echo e($students->registerNo); ?>" class="form-control"required></br>
        <label>Roll<span class="text-danger"></span></label></br>
        <input type="text" name="roll" id="roll" value="<?php echo e($students->roll); ?>" class="form-control"></br>
        ...
        <div class="col-sm-6">
                    ...
                    <div class='form-group' >                        <label for="username" class="col-sm-2 control-label">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="username" name="username" value="<?php echo e($students->username); ?>" >
                        </div>
                         <span class="col-sm-4 control-label">
                                                    </span>
                    </div>
        ...
        <button type="submit" class="btn btn-success" title="Update Student" onclick="return confirm
             ('are you want to Edit Student')"><i class="fa fa-trash-o" aria-hidden="true"></i> Update Student</button>
...
<?php /**PATH C:\xampp\htdocs\demo.asteims\resources\views/student/edit.blade.php ENDPATH**/ ?>