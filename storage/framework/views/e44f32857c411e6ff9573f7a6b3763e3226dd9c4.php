...
<div class="wrapper">
  ...
  <div class="card-body">
      <form action="<?php echo e(route('studentstore')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\demo.asteims\resources\views/student/create.blade.php ENDPATH**/ ?>