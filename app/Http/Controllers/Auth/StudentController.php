...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('flash_message', 'Student Addedd!');
              $request->validate([
    ...
    {
        $destination_path = 'public/images/studentimages';
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->back()->with('flash_message', 'Student Updated!');
