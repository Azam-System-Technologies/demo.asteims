...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <div class="card">
  <div class="card-header"> Edit Location Page</div>
  <div class="card-body">
      
      <form action="{{ url('/location/update') }}" method="post">
        {!! csrf_field() !!}
        @method('PUT')
        <input type="hidden" name="pid"  value="{{ $location->id }}" />

        <h1>Location Information</h1>
        <label> Location <span class="text-danger"> *</span></label></br>
        <input type="text" name="location"  class="form-control" value="{{ $location->location}}"></br>
        <label>Description</label></br>
        <textarea type="text" name="desc" rows="10" cols="145" "> {{ $location->description}} </textarea>
