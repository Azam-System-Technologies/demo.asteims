...
>>>>>>> 428e030 (User Code)
       ...
       <!-- <input type="submit" value="Save" class="btn btn-success"></br>-->
        <button type="submit" class="btn btn-success" title="Add Teachers" onclick="return confirm
             ('are you want to Add Teachers')"><i class="fa fa-trash-o" aria-hidden="true"></i> Save</button>
<<<<<<< HEAD
=======
  <div class="card-header">Add Teacher Details</div>
  <div class="card-body">
      ...
      <form action="{{route('teacher_store')}}" method="post" enctype="multipart/form-data">
        ...
        <label>Joining Date<span class="text-danger"> *</span></label></br>
        <input type="date" name="joining_date" id="joining_date" class="form-control" required></br>
       ...
       <!-- <input type="submit" value="Save" class="btn btn-success"></br>-->
        <button type="submit" class="btn btn-secondary" title="Add Teachers" onclick="return confirm
             ('are you want to Add Teachers')"><i class="fa fa-trash-o" aria-hidden="true"></i> Add Teacher</button>
>>>>>>> 961abd5 (shahab)
=======
>>>>>>> 428e030 (User Code)
    </form>
