...
<div class="wrapper">
  ...
  <div class="card-body">
        ...
        <p class="card-text"> Photo: <img src="{{asset('/storage/images/studentimages/'. $students->file_path)}}" width="30%"></p>
        <h5 class="card-title">Name : {{ $students->name }}</h5>


        <p class="card-text">blood Group : {{  $students->bloodgroup }}</p>
        <p class="card-text">Email : {{ $students->email }}</p>

        <p class="card-text">Interviewer Notes : {{  $students->remarks}}</p>
        <p class="card-text">Extra Curricular Activities: {{  $students->extra_curricular_activities}}</p>
        <p class="card-text">Optional Subject: {{ $students->optionalSubjectID}}</p>
        <p class="card-text">Gender : {{  $students->gender }}</p>
        <p class="card-text">Religion : {{  $students->religion }}</p>
        <p class="card-text">Phone : {{ $students->phone }}</p>
        <p class="card-text">Country: {{  $students->country }}</p>
        <p class="card-text">Username: {{  $students->username }}</p>
