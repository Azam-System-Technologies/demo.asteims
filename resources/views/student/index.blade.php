                            ...
                            <table class="table">
                                ...
                                @foreach($students as $item)
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{asset('/storage/images/studentimages/'.$item->file_path)}}" width="25px" alt="student photo" title="photo"></td>
                                        <td>{{ $item->name }}</td>
                                        <td>{{ $item->roll }}</td>
                                        <td>{{ $item->email }}</td>
                                        <td>{{ $item->status }}</td>
                                        ...
                                        <td>
                                            <a href="{{ url('/student/show/'.$item->id) }}" title="View Student"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            ...
                                            <form method="POST" action="{{ url('student/delete') }}" accept-charset="UTF-8" style="display:inline">
