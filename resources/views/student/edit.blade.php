...
<div class="wrapper">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('/student/update') }}" method="post"enctype="multipart/form-data">
        ...
        <select name="guardian" id="guardian" value="{{$students->guardian}}" class="form-control">
...
<option value="31">Shahab</option>
        ...
        <select name="gender" id="gender" value="{{$students->gender}}"  class="form-control">
...
<option value="AX">Aland Islands</option>
        ...
        <select name="class_id" id="class_id" value="{{$students->class_id}}" class="form-control select2" required>
...
<option value="24">Test</option>
        ...
        <select name="section_id" id="section_id" value="{{$students->section_id}}" class="form-control select2" required>
        ...
        <select name="campus_id" id="campus_id" value="{{$students->campus_id}}" class="form-control select2" required>
...
<option value="5">Arts</option>
        ...
        <input type="text" name="registerNo" id="registerNo" value="{{$students->registerNo}}" class="form-control"required></br>
        <label>Roll<span class="text-danger"></span></label></br>
        <input type="text" name="roll" id="roll" value="{{$students->roll}}" class="form-control"></br>
        ...
        <div class="col-sm-6">
                    ...
                    <div class='form-group' >                        <label for="username" class="col-sm-2 control-label">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="username" name="username" value="{{$students->username}}" >
                        </div>
                         <span class="col-sm-4 control-label">
                                                    </span>
                    </div>
