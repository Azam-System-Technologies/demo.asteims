...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <div class="card">
  <div class="card-header">Vendor Page</div>
  <div class="card-body">
      
      <form action="{{ url('ven_insert')}}" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <h1>Vendor Information</h1>
        <label>Name <span class="text-danger"> *</span></label></br>
        <input type="text" name="vend_name"  class="form-control"></br>
        <label>Email</label></br>
        <input type="email" name="vend_email"  class="form-control"></br>
        <label>Phone</label></br>
        <input type="text" name="vend_phone"  class="form-control"></br>
        ...
        <button type="submit" class="btn btn-success" title="Add Student" onclick="return confirm
             ('are you want to Add Student')"><i class="fa fa-trash-o" aria-hidden="true"></i>Add Vendor</button>
    </form>
