...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <div class="card">
  <div class="card-header"> Edit Vendor Page</div>
  <div class="card-body">
      
      <form action="{{ url('/vendor/update') }}" method="post">
        {!! csrf_field() !!}
        @method('PUT')
        <input type="hidden" name="pid"  value="{{ $vendor->id }}" id="id" />

        <h1>Vendor Information</h1>
        <label>Name <span class="text-danger"> *</span></label></br>
        <input type="text" name="vend_name"  class="form-control" value="{{$vendor->name}}" ></br>
        <label>Email</label></br>
        <input type="email" name="vend_email"  class="form-control" value="{{$vendor->email}}" ></br>
        <label>Phone</label></br>
        <input type="text" name="vend_phone"  class="form-control" value="{{$vendor->phone}}"></br>
        <label>Contact Name</label></br>
        <input type="text" name="contact_name"  class="form-control" value="{{$vendor->contact_name}}"></br>
