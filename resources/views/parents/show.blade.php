...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <div class="card">
  <div class="card-header">View Parents Page</div>
  <div class="card-body">
  
        <div class="card-body">
        <h5 class="card-title">Student's Father's Name: {{$parent->father_name}}</h5>
        <p class="card-text">Father's Profession : {{$parent->father_profession}}</p>
        <p class="card-text">Student's Mother's Name : {{$parent->mother_name}}</p>
        <p class="card-text">Mother's Profession : {{$parent->mother_profession}} </p>
        <p class="card-text">Email : {{$parent->email}} </p>
        <p class="card-text">Address : {{$parent->address}}</p>
        <p class="card-text">Username : {{$parent->username}}</p>
