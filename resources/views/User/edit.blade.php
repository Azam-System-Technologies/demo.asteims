    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('manages')}}" class="nav-link">
              <i class="nav-icon fas fa-user"></i>
              <p>
              Mgmt & Support Staff
...
<option value="Female">Female</option>
                    ...
                    <div class='form-group' >                        <label for="jod" class="col-sm-2 control-label">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control" id="jod" name="jod" value="{{$user->jod}}" >
                        </div>
                        <span class="col-sm-4 control-label">
                                                    </span>
                    </div>
                    ...
                    <div class='form-group' >                        <label for="usertypeID" class="col-sm-2 control-label">
                        ...
                        <div class="col-sm-6">
                            <select name="usertypeID" id='usertypeID'  class="form-control" value="{{$user->usertypeID}}">
